...
Well, this snip is pretty dinky as far as I'm concerned, but for those of
us who just really are lazy, no need to port this to ROM 2.4 on your own,
as I have now done it for you (maybe I just like seeing my name in print,
I don't know :). I'll make up for it someday and post my revision of the
language code by the Maniac. At least one coder whom I respect very much
informed me that he liked what I did with it. ;)

There's also at least one bug fix in here, the simple snipping of the
duplicated lines which weren't really needed and threw off anything you
said that included the second half of the alphabet. *snicker*

So, there you have it, no need to accredit me anywhere where the players
can see, I just ask that you keep the credits in the drunk.c file included
in this 'package' intact and 'as is', though you may certainly add your
own credits should you modify this thing. :)

I do ask that you put the Maniac's name somewhere in a publically visible
helpfile (that is, one that all players can see), accrediting him for the
drunken speech code contained herein. :)

You know the drill, my email is foxyrev@hotmail.com if you need it..
...
In act_comm.c, just before the 'You gossip blah blah blah' part of each
channel's code, put this:
